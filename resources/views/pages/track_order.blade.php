                ...
                <div class="order-details">
                    ...
                    <div class="table-content table-responsive mb--30">
                        <table class="table order-table order-table-2">
                            ...
                            <thead>
                                <tr>
                                    <th><strong>Họ tên người đặt: </strong>{{ $order->customer->first_name }} {{ $order->customer->last_name }}</th>
                            ...
                            <thead>
                                <tr>
                                    <th><strong>Địa chỉ:</strong> {{ $order->customer->street_address }}, {{ $order->customer->city }}</th>
                            ...
                            <thead>
                                <tr>
                                    <th><strong>Email:</strong> {{ $order->customer->email }}</th>
                            ...
                            <thead>
                                <tr>
                                    <th><strong>SĐT:</strong> {{ $order->customer->phone }}</th>
                            ...
                            <thead>
                                <tr>
                                    <th><strong>Trạng thái:</strong> {{ $order->status }}</th>
